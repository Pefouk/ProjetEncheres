...
public class EnchereManager {
		...
		public Encheres createEncheres(int noUtilisateur, String nomarticle, String description, String categorie, String miseaprix, String datefin, String rue, String codepostal, String ville) throws BLLException {
			//condition
			int categ;
			int prix;
			Date dateDeFin = Date.valueOf(datefin);
			
			if (nomarticle == null || description == null || categorie == null || miseaprix == null || datefin == null || rue == null || codepostal == null || ville == null)
